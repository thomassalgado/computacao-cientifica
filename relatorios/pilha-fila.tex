...
O método \textbf{\textit{empilha}} recebe como parâmetro uma string e verifica se ainda existe espaço na pilha para a inserção de novos itens. caso exista, insere o novo elemento na fila, retornando uma mensagem de sucesso, caso contrário, retorna uma mensagem de erro informando que a fila esta cheia.
